                                    ...
                                    <table class='table table-bordered table-striped'
                                        ...
                                        <c:forEach items="${page.list}" var="h">
                                            <tr>
                                                ...
                                                <td>${h.hallName}</td>
                                                <td>${h.cinema.cinemaName}</td>
                                                <td>
                                                    <button class="btn btn-warning" name="button"
                                                            style="margin-bottom:5px" type="submit"
                                                            onclick="location='/zijingwang/hall/${h.hallId}/hallDetail'">查看
                                                    </button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger" name="button"
                                                            style="margin-bottom:5px" type="submit"
                                                            onclick="location='/zijingwang/hall/${h.hallId}/hallDelete'">删除
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                    ...
                    <tr>
                        <td align="right">
                            ...
                            <c:if test="${page.current != 1}">
                                <a href="/zijingwang/hall/hallList?cur=1">[首页]</a>&nbsp;&nbsp;
                                <a href="/zijingwang/hall/hallList?cur=${page.current-1}">[上一页]</a>&nbsp;&nbsp;
                            </c:if>
                                <c:forEach begin="1" end="${page.total }" var="cur">
                                    <a href="/zijingwang/hall/hallList?cur=${cur}">${cur }</a>
                                </c:forEach>
                            <c:if test="${page.current != page.total}">
                                <a href="/zijingwang/hall/hallList?cur=${page.current+1}">[下一页]</a>&nbsp;&nbsp;
                                <a href="/zijingwang/hall/hallList?cur=${page.total}">[尾页]</a>&nbsp;&nbsp;
                            </c:if>
			                </span>
                        </td>
                    </tr>
