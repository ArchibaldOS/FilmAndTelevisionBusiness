                                            ...
                                            <tr>
                                                ...
                                                <span>
                                                    <c:if test="${page.current != 1}">
                                                        <a href="/zijingwang/comment/commentList?cur=1">[首页]</a>&nbsp;&nbsp;
                                                        <a href="/zijingwang/comment/commentList?cur=${page.current-1}">[上一页]</a>&nbsp;&nbsp;
                                                    </c:if>
                                                    <c:forEach begin="1" end="${page.total }" var="cur">
                                                        <a href="/zijingwang/comment/commentList?cur=${cur}">${cur }</a>
                                                    </c:forEach>
                                                    <c:if test="${page.current != page.total}">
                                                        <a href="/zijingwang/comment/commentList?cur=${page.current+1}">[下一页]</a>&nbsp;&nbsp;
                                                        <a href="/zijingwang/comment/commentList?cur=${page.total}">[尾页]</a>&nbsp;&nbsp;
                                                    </c:if>
			                                    </span>
                                                </td>
                                            </tr>
