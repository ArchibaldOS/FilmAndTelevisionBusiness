            ...
            <div class='row-fluid' id='content-wrapper'>
                <div class='span12'>
                    ...
                    <div class='row-fluid'>
                            ...
                            <hr class='hr-normal' />
                            <div class='control-group'>
                                <label class='control-label' for='inputText1'><b>作者</b></label>
                                <div class='controls' style="margin-top: 5px;">
                                    ${a.author }
                                </div> 
                            </div>
                            <div class='control-group'>
                                <label class='control-label' for='inputSelect'><b>关键字</b></label>
                                <div class='controls' style="margin-top: 5px;">
                                    ${a.keyword }
                                </div>
                            </div>
                            <div class='control-group'>
                                <label class='control-label' for='inputText1'><b>正文</b></label>
                                <div class='controls' style="margin-top: 5px;">
                                	${a.articleContent }
                                </div>
                            </div>
