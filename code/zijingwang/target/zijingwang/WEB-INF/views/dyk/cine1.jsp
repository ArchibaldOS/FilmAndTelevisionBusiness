...
<div class="widget-movie-detail-more">
    ...
    <div class="recommend">
        ...
        <form name="cinema" action="cine1">
        <c:forEach items="${timing}" var="s">
            ...
            <li style="width:100%;height:80px">
               ...
               <a href="login?cinema=${s.cinema}&filmHall=${s.filmHall}&filmName=${s.filmName}&filmTime=${s.filmTime}" target="_blank" style="font-size:25px;">${s.cinema}&nbsp;&nbsp;&nbsp;&nbsp;时间：${s.filmTime}&nbsp;&nbsp;&nbsp;${s.filmHall}厅</a>
