...
<!--[if lt IE 9]>
    ...
    <![endif]-->
   <%--  <link href='${basePath }a/a.css' rel="stylsheet" type="text/css"/> --%>
...
<!-- / xeditable -->
<link
	href='assets/stylesheets/plugins/xeditable/bootstrap-editable.css'
	media='all' rel='stylesheet' type='text/css' />
<link
	href='assets/stylesheets/plugins/common/bootstrap-wysihtml5.css'
	media='all' rel='stylesheet' type='text/css' />
<!-- / wysihtml5 (wysywig) -->
<link
	href='assets/stylesheets/plugins/common/bootstrap-wysihtml5.css'
...
<link href='assets/stylesheets/plugins/fullcalendar/fullcalendar.css'
	media='all' rel='stylesheet' type='text/css' />
<!-- / select2 -->
<link href='assets/stylesheets/plugins/select2/select2.css'
	media='all' rel='stylesheet' type='text/css' />
<!-- / mention -->
<link href='assets/stylesheets/plugins/mention/mention.css'
	media='all' rel='stylesheet' type='text/css' />
<!-- / tabdrop (responsive tabs) -->
<link href='assets/stylesheets/plugins/tabdrop/tabdrop.css'
	media='all' rel='stylesheet' type='text/css' />
...
<body class='contrast-blue '>
	...
	<div class='navbar'>
		<div class='navbar-inner'>
			<div class='container-fluid'>
				 <a class='brand' href='/zijingwang'> <i
				...
				<ul class='nav pull-right'>
					...
					<li class='dropdown dark user-menu'><a class='dropdown-toggle'
						data-toggle='dropdown' href='#'> <img alt='Mila Kunis'
							...
							class='user-name hidden-phone'>张雨欣</span> <b class='caret'></b>
					</a>
						<ul class='dropdown-menu'>
					...
					<div class='row-fluid'>
						<div class='span12'>
							<div class='page-header'>
								<h1 class='pull-left'>
									<i class='icon-edit'></i> <span>文章管理</span>
								</h1>
							</div>
						</div>
					</div>
						...
						<div class='span12 box' style='margin-bottom: 0'>
							...
							<div class='box-content'>
								<div class='tab-content'>
									<form accept-charset="UTF-8" action="/zijingwang/articleAdd" class="form form-horizontal" method="post"
										style="margin-bottom: 0;" onsubmit="return check()" />
									...
									<div class='control-group'>
										<label class='control-label' for='inputText1'>文章标题</label>
										<div class='controls'>
											<input id='inputText1' placeholder='articleTitle' type='text'
												name="title" /><span id="msg1"></span>
											<!--修改name与数据库英文名称统一-->
										</div>
									</div>
									<div class='control-group'>
										<label class='control-label' for='inputText2'>文章作者</label>
										<div class='controls'>
											<input id='inputText2' placeholder='articlAuthor' type='text'
												name="author" /><span id="msg2"></span>
											<!--修改name与数据库英文名称统一-->
										</div>
									</div>
									<hr class='hr-normal' />
									<div class='control-group'>
										<label class='control-label' for='inputText1'>文章关键字</label>
										<div class='controls'>
											<textarea id='inputText3' placeholder='keyword'
												name="keyword" rows="3" cols="20"></textarea><span id="msg3"></span>
										</div>
									</div>
									<div >
										<label class='control-label' for='inputText1'>文章内容</label>
										<div style="margin-left: 180px;margin-right: 180px;" position="absolute">
											<textarea id='inputText4' placeholder='articleContent'
												name="articleContent" rows="10" ></textarea><span id="msg4"></span>
										</div>
									</div>
	...
	<script type="text/javascript">
		var title = document.getElementById("inputText1");
		var author = document.getElementById("inputText2");
		var keyword = document.getElementById("inputText3");
		var articleContent = document.getElementById("inputText4");
		...
		title.onblur = function( e ){
			if(title.value == ""){
				...
				msg1.innerHTML = "标题不能为空！";
			}else{
				this.style.borderColor = "green";
				msg1.innerHTML = "";
			}
		}
		author.onblur = function( e ){
			if(author.value == ""){
				this.style.borderColor = "red";
				msg2.style.color = "red";
				msg2.innerHTML = "作者不能为空！";
			}else{
				this.style.borderColor = "green";
				msg2.innerHTML = "";
			}
		...
		keyword.onblur = function( e ){
			if(keyword.value == ""){
				...
				msg3.innerHTML = "关键字不能为空！";
			}else{
				this.style.borderColor = "green";
				msg3.innerHTML = "";
			}
		}
		articleContent.onblur = function( e ){
			if(articleContent.value == ""){
				this.style.borderColor = "red";
				msg4.style.color = "red";
				msg4.innerHTML = "内容不能为空！";
			}else{
				this.style.borderColor = "green";
				msg4.innerHTML = "";
			}
		...
		function check() {
			if(title.value == "" || author.value == "" || keyword.value == "" || articleContent.value == ""){
				alert("请填写完整！");
				return false;
			}else{
				alert("提交成功！");
	...
	<script src='assets/javascripts/demo/inplace_editing.js'
		type='text/javascript'></script>
	<script src='assets/javascripts/demo/charts.js'
		type='text/javascript'></script>
