					...
					<div class='row-fluid'>
						<div class='span12 box' style='margin-bottom: 0'>
							...
							<div class='box-content'>
								<form accept-charset="UTF-8" action="/zijingwang/addSense"
								...
								<div class='control-group'>
									<label class='control-label' for='inputText1'>敏感词内容：</label>
									<div class='controls'>
										<input id='senseContent' type='text' name="senseContent" /><span id="msg"></span>
									</div>
								</div>
...
<script type="text/javascript">
		var senseContent = document.getElementById("senseContent");
		var msg = document.getElementById("msg");
		senseContent.onblur = function( e ){
			if(senseContent.value == ""){
