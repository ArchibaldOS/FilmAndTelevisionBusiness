            ...
            <div class='container-fluid'>
                <div class='row-fluid' id='content-wrapper'>
                    <div class='span12'>
                        ...
                        <!--页面内标签-->
                        <div class='row-fluid'>
                        <c:set var="s" value="${requestScope.senseWord }" />
                                <form accept-charset="UTF-8" action="/zijingwang/senseUpdate" class="form form-horizontal" method="post" style="margin-bottom: 0;" />
                                <div style="margin:0;padding:0;display:inline">
                                    <input name="senseId" type="hidden" value="${s.senseId }" />
                                </div>
                            <hr class='hr-normal' />
                            <div class='control-group'>
                                <label class='control-label' for='inputText1'>内容</label>
                                <div class='controls'>
                                    <input id='inputText1'  type='text'  name="senseContent" value="${s.senseContent }" />
                                </div>
