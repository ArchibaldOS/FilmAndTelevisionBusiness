                ...
                <div class='span12'>
                    ...
                    <div class='row-fluid'>
                        <div class="tab-pane active" id="retab1"><!--p>学校用户列表</p-->
                            <form accept-charset="UTF-8" action="/zijingwang/ResetPasswordDO" class="form form-horizontal" method="post" style="margin-bottom: 0;" >
                                <div style="margin:0;padding:0;display:inline">
                                    <input name="utf8" type="hidden" value="&#x2713;" />
                                    <input name="authenticity_token" type="hidden" value="CFC7d00LWKQsSahRqsfD+e/mHLqbaVIXBvlBGe/KP+I=" />
                                </div>
                                <div class='control-group'>
                                    <label class='control-label' for='inputText1'>用户ID</label>
                                    <div class='controls'>
                                        <input id='inputText1' placeholder='ID' type='text' name="userID"  /><!--修改name与数据库英文名称统一-->
                                    </div>
                                </div>
                                <hr class='hr-normal' />
                                <div class='control-group'>
                                    <label class='control-label' for='inputText1'>原密码</label>
                                    <div class='controls'>
                                        <input id='inputText1' placeholder='old password' type='text'  name="oldPassword"/>
                                    </div>
                                </div>
                                <div class='control-group'>
                                    <label class='control-label' for='inputText1'>新密码</label>
                                    <div class='controls'>
                                        <input id='inputText1' placeholder='new password' type='text'  name="newPassword"/>
                                    </div>
                                </div>
                                <div class='control-group'>
                                    <label class='control-label' for='inputText1'>确认密码</label>
                                    <div class='controls'>
                                        <input id='inputText1' placeholder='check your new password' type='text'  name="checkPassword"/>
                                    </div>
                                </div>
                                ...
                                <div class='form-actions'>
                                    ...
                                    <button class='btn'  onclick="location='/UserList.do'">返回</button>
                                </div>
                                <!--保存重置-->
                          </form>
                     </div>
