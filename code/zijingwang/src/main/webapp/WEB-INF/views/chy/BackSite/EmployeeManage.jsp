...
//                                                }
                                            ...
                                            <c:forEach var="employee" items="${employees}">
                                                <tr>
                                                    ...
                                                    <td><button id="delete" class="btn btn-danger" name="button" style="margin-bottom:5px" type="submit" onclick="location='/deleteEmployee.do?userid=${employee.userid}'">删除</button></td>
                                                </tr>
                                            </c:forEach>
