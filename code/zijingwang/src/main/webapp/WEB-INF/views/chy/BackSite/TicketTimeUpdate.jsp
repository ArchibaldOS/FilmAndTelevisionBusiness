                ...
                <div class='span12'>
                    ...
                    <div class='row-fluid'>
                        <div class="tab-pane active" id="retab1"><!--p>学校用户列表</p-->
                            <form accept-charset="UTF-8" action="/TicketTimeUpdate.do" class="form form-horizontal" method="get" style="margin-bottom: 0;" >
                                ...
                                <div class='control-group'>
                                    <div class='controls'>
                                        <input id='inputText1' value="${screening.screeningnumber}" type='hidden' name="screeningnumber" /><!--修改name与数据库英文名称统一-->
                                    </div>
                                </div>
                                <div class='control-group'>
                                ...
                                <div class='control-group'>
                                    <label class='control-label' for='mydate'>售票时间</label>
                                    <div class='controls'>
                                        <input id='mydate'value="${screening.saletime}"  type="datetime" name="sometime" />
                                    </div>
                                </div>
                                <div class='control-group'>
                                ...
                                <div class='form-actions'>
                                    ...
                                    <button class='btn' onclick="location='/TicketTimeManage.do?'">返回</button>
                                </div>
                                <!--保存重置-->
                            </form>
                        </div>
