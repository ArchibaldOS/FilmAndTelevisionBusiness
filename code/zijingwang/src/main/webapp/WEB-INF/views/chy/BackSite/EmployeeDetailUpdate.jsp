<%@ page import="com.six.FilmAndTelevisionBusiness.entity.Employee" %>
...
<div id='wrapper'>
    ...
    <section id='content'>
        <%--自适应屏幕--%>
        <div class='container-fluid'><%-- 表明内容布局是流布局，作为一个包含块来容纳流布局内容 --%>
            <div class='row-fluid' id='content-wrapper'><%--决定是否是流布局 --%>
                <div class='span12'><%-- 对应不同的百分比--%>
                            ...
                            <div class='row-fluid'>
                                <div class='span12 box bordered-box blue-border' style='margin-bottom:10px;'>
                                    ...
                                    <div class='box-content'>
                                        <form accept-charset="UTF-8" action="/EmployeeDetailUpdate.do" class="form form-horizontal" method="get" style="margin-bottom: 0;" >
