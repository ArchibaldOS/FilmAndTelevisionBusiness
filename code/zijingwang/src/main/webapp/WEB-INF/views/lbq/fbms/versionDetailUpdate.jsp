                ...
                <div class='span12'>
                    ...
                    <div class='row-fluid'>
                        <div class="tab-pane active" id="retab1">
                            <form accept-charset="UTF-8" action="/zijingwang/version/versionUpdate" class="form form-horizontal" method="post" style="margin-bottom: 0;" >
                            ...
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <input id="versionId" type="hidden" name="versionId" value="${version.versionId}">
                                    <input id='versionName'  type='text' name="versionName" value="${version.versionName}" /><!--修改name与数据库英文名称统一-->
                                </div>
                            </div>
