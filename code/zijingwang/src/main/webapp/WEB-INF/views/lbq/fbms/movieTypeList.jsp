                            ...
                            <div class='responsive-table'>
                                <div class='scrollable-area'>
                                    <table class=' table table-bordered table-striped'
                                        ...
                                        <tbody>
                                        <c:forEach items="${page.list}" var="mt">
                                            <tr>
                                                <td><input type="checkbox" name=""></td>
                                                <td>${mt.movieTypeName}</td>
                                                <td>
                                                    <button class="btn btn-warning" name="button"
                                                            style="margin-bottom:5px"
                                                            type="submit"
                                                            onclick="location='/zijingwang/movieType/${mt.movieTypeId}/movieTypeDetail'">
                                                        查看
                                                    </button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger" name="button"
                                                            style="margin-bottom:5px"
                                                            type="submit"
                                                            onclick="location='/zijingwang/movieType/${mt.movieTypeId}/movieTypeDelete'">
                                                        删除
                                                    </button>
                                                </td>
                                            </tr>
                                    ...
                                    <table table border="0" cellspacing="0" cellpadding="0" width="900px">
                                        <tr>
                                            <td align="right">
                                                <span>第${page.current}/${page.total}页</span>
                                                <span>
                                                    <c:if test="${page.current != 1}">
                                                        <a href="/zijingwang/movieType/movieTypeList?cur=1">[首页]</a>&nbsp;&nbsp;
                                                        <a href="/zijingwang/movieType/movieTypeList?cur=${page.current-1}">[上一页]</a>&nbsp;&nbsp;
                                                    </c:if>
                                                    <c:forEach begin="1" end="${page.total }" var="cur">
                                                        <a href="/zijingwang/movieType/movieTypeList?cur=${cur}">${cur }</a>
                                                    </c:forEach>
                                                    <c:if test="${page.current != page.total}">
                                                        <a href="/zijingwang/movieType/movieTypeList?cur=${page.current+1}">[下一页]</a>&nbsp;&nbsp;
                                                        <a href="/zijingwang/movieType/movieTypeList?cur=${page.total}">[尾页]</a>&nbsp;&nbsp;
                                                    </c:if>
			                                    </span>
                                            </td>
                                        </tr>
