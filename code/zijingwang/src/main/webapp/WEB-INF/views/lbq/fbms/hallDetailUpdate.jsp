            ...
            <div class='span12'>
                ...
                <div class='row-fluid'>
                    <div class="tab-pane active" id="retab1">
                        <form accept-charset="UTF-8" action="/zijingwang/hall/hallUpdate" class="form form-horizontal" method="post" style="margin-bottom: 0;" />
                        ...
                        <div class='control-group'>
                            ...
                            <div class='controls'>
                                <input id="hallId" type="hidden" name="hallId" value="${hall.hallId}">
                                <input id='hallName' type='text' name="hallName" value="${hall.hallName}"  /><!--修改name与数据库英文名称统一-->
                            </div>
                        </div>
                        <hr class='hr-normal' />
                        <div class='control-group'>
                            ...
                            <div class='controls'>
                                <input id='cinemaName'  type='text'  name="cinema.cinemaName" value="${hall.cinema.cinemaName}" />
                            </div>
                        </div>
