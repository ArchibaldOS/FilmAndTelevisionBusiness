                ...
                <div class='span12'>
                    ...
                    <div class='row-fluid'>
                        <div class="tab-pane active" id="retab1">
                            <form accept-charset="UTF-8" action="/zijingwang/version/${version.versionId}/versionDetailUpdate" class="form form-horizontal" method="post" style="margin-bottom: 0;" />
                            ...
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <input id='versionName'  type='text' name="versionName" value="${version.versionName}" readonly="readonly" /><!--修改name与数据库英文名称统一-->
                                </div>
                            </div>
