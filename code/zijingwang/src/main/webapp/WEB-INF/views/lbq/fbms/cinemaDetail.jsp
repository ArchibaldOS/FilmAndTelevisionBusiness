                ...
                <div class='row-fluid'>
                    <div class="tab-pane active" id="retab1">
                        ...
                        <div class='control-group'>
                            <label class='control-label' for='cinemaName'>影城名称</label>

                            <div class='controls'>
                                <input id='cinemaName' type='text' name="cinemaName" value="${cinema.cinemaName}"
                        ...
                        <div class='control-group'>
                            ...
                            <div class='controls'>
                                <input id='address' type='text' name="address" value="${cinema.address}" readonly="readonly"/>
                            </div>
                        ...
                        <div class='control-group'>
                            ...
                            <div class='controls'>
                                <input id='telephone'  type='text' name="telephone" value="${cinema.telephone}"
                                       readonly="readonly"/>
                            </div>
                        </div>
                        <div class='control-group'>
                            <label class='control-label' for='payOnline'>支持在线售票</label>

                            <div class='controls'>
                                <c:if test="${cinema.payOnline=='true'}">
                                <input id='payOnline'  type='text' name="payOnline" value="是"
                                       readonly="readonly"/>
                                </c:if>
                                <c:if test="${cinema.payOnline=='false'}">
                                    <input id='payOnline'  type='text' name="payOnline" value="否"
                                           readonly="readonly"/>
                                </c:if>
                            </div>
                        </div>
                        <hr class='hr-normal'/>
                        <div class='control-group'>
                            <label class='control-label' for='introduction'>影院介绍</label>

                            <div class='controls'>
                                <textarea id='introduction' name="introduction"
                                          readonly="readonly">${cinema.introduction}</textarea>
                            </div>
                        </div>

                        <!--保存重置-->
                        <div class='form-actions'>
                            <button class='btn btn-primary' type='button' onclick="location='/zijingwang/cinema/cinemaDetailUpdate'">
                                <i class='icon-save'></i>
                                修改
                            </button>
