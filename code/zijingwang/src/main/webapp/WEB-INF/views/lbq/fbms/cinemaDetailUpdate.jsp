                ...
                <div class='span12'>
                    ...
                    <div class='row-fluid'>
                        <div class="tab-pane active" id="retab1">
                            <form accept-charset="UTF-8" action="/zijingwang/cinema/cinemaUpdate" class="form form-horizontal" method="post" style="margin-bottom: 0;" />
                            ...
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <input id='cinemaName'  type='text' name="cinemaName" value="${cinema.cinemaName}" /><!--修改name与数据库英文名称统一-->
                                </div>
                            </div>
                            <hr class='hr-normal' />
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <input id='address'  type='text'  name="address" value="${cinema.address}" />
                                </div>
                            ...
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <input id='payOnline'  type='text' name="payOnline" value="${cinema.payOnline}" />
                                </div>
                            </div>
                            <hr class='hr-normal' />
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <textarea id='introduction'  name="introduction" >${cinema.introduction}</textarea>
                                </div>
                            </div>
