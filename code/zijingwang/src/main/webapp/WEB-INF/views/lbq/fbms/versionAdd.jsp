...
<head>
    ...
    <!-- / color picker -->
    <link href='/zijingwang/assets/stylesheets/plugins/bootstrap_colorpicker/bootstrap-colorpicker.css' media='all' rel='stylesheet'
          type='text/css'/>
    <!-- / datetime picker -->
                ...
                <div class='row-fluid'>
                    <div class='span12 box' style='margin-bottom: 0'>
                        ...
                        <div class='box-content'>
                            <form accept-charset="UTF-8" action="/zijingwang/version/versionAddAction" class="form form-horizontal"
                            ...
                            <div class='control-group'>
                                <label class='control-label' for='versionName'>影片版本</label>

                                <div class='controls'>
                                    <input id='versionName' type='text' name="versionName"/>
                                </div>
                            </div>
