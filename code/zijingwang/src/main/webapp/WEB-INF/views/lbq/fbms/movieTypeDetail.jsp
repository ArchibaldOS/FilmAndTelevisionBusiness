                ...
                <div class='span12'>
                    ...
                    <div class='row-fluid'>
                        <div class="tab-pane active" id="retab1">
                            <form accept-charset="UTF-8" action="/zijingwang/movieType/${movieType.movieTypeId}/movieTypeDetailUpdate" class="form form-horizontal" method="post" style="margin-bottom: 0;" />
                            ...
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <input id='movieTypeName'  type='text' name="movieTypeName" value="${movieType.movieTypeName}" readonly="readonly" /><!--修改name与数据库英文名称统一-->
                                </div>
                            </div>
