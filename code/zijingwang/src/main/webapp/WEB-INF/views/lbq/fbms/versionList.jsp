                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-warning" name="button"
                                                            ...
                                                            type="submit"
                                                            onclick="location='/zijingwang/version/${v.versionId}/versionDetail'">
                                                        查看
                                                    </button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger" name="button"
                                                            style="margin-bottom:5px"
                                                            type="submit"
                                                            onclick="location='/zijingwang/version/${v.versionId}/versionDelete'">
                                                        删除
                                                    </button>
                                                </td>
                                            </tr>
                                            ...
                                            <td align="right">
                                                ...
                                                <span>
                                                    <c:if test="${page.current != 1}">
                                                        <a href="/zijingwang/version/versionList?cur=1">[首页]</a>&nbsp;&nbsp;
                                                        <a href="/zijingwang/version/versionList?cur=${page.current-1}">[上一页]</a>&nbsp;&nbsp;
                                                    </c:if>
                                                    <c:forEach begin="1" end="${page.total }" var="cur">
                                                        <a href="/zijingwang/version/versionList?cur=${cur}">${cur }</a>
                                                    </c:forEach>
                                                    <c:if test="${page.current != page.total}">
                                                        <a href="/zijingwang/version/versionList?cur=${page.current+1}">[下一页]</a>&nbsp;&nbsp;
                                                        <a href="/zijingwang/version/versionList?cur=${page.total}">[尾页]</a>&nbsp;&nbsp;
                                                    </c:if>
			                                    </span>
                                            </td>
                                        </tr>
