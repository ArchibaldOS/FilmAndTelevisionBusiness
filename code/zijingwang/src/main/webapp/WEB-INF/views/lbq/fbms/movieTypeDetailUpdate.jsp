                ...
                <div class='span12'>
                    ...
                    <div class='row-fluid'>
                        <div class="tab-pane active" id="retab1">
                            <form accept-charset="UTF-8" action="/zijingwang/movieType/movieTypeUpdate" class="form form-horizontal" method="post" style="margin-bottom: 0;" />
                            <div style="margin:0;padding:0;display:inline">
                                <input name="utf8" type="hidden" value="&#x2713;" />
                                <input name="authenticity_token" type="hidden" value="CFC7d00LWKQsSahRqsfD+e/mHLqbaVIXBvlBGe/KP+I=" />
                            </div>
                            <div class='control-group'>
                                <label class='control-label' for='movieTypeName'>影片类型</label>
                                <div class='controls'>
                                    <input id="movieTypId" type="hidden" name="movieTypeId" value="${movieType.movieTypeId}">
                                    <input id='movieTypeName'  type='text' name="movieTypeName" value="${movieType.movieTypeName}" /><!--修改name与数据库英文名称统一-->
                                </div>
                            </div>
