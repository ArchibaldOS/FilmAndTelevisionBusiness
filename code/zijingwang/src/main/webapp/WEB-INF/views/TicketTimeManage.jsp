...
//                                                }
                                                ...
                                                <c:forEach var="screening" items="${screenings}">
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-success" name="button" style="margin-bottom:5px" type="submit" onclick="location='/MovieDetail.do?screeningnumber=${screening.screeningnumber}'">查看</button></td>
                                                        ...
                                                        <td><button class="btn btn-danger" name="button" style="margin-bottom:5px" type="submit" onclick="location='/TicketTimeDelete.do?screeningnumber=${screening.screeningnumber}'">删除</button></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
