...
<div class="widget-movie-detail-intro" id="detailIntro">
    <div class="container clearfix">
        <c:set var="a" value="${requestScope.info}"/>
        <div class="fl poster">
    ...
    <div class="recommend">
        ...
        <c:forEach items="${cinema}" var="s">
            ...
            <li style="width:100%;height:80px">
               ...
               <a href="jump?filmId=${s.filmId}&filmName=${a.name}" target="_blank" style="font-size:25px;">${s.address}&nbsp;&nbsp;${s.price}元</a>
